...
class RatingCanvas(tk.Frame):
    def __init__(self, master, title):
        ...
        self.book_ratings = [
            ...
            0,
            0,
        ]  # Αρχικοποιώντας σε 0 άν δεν υπάρχουν αξιολογήσεις θα δείχνει κενό γράφημα
    ...
    def get_ratings(self, title):
        ratings = database.get_book_ratings(
            title
        )  # Η ratings είναι λίστα από πλειάδες της μορφής (rating, comment, username)
        list_ratings = []
        ...
        if ratings is not None:
            for entry in ratings:
                list_ratings.append(
                    entry.id
                )  # Προσθέτουμε στη λίστα μόνο την αξιολόγηση
    ...
    def plot_ratings(self):
        ...
        ax.bar(
            ["1", "2", "3", "4", "5"], self.book_ratings
        )  # Ετικέτες του χ οι τιμές 1-5, τιμές του y οι τιμές της book_ratings
