...
class EntryWithText (ttk.Frame):
    def __init__(self, master,title:str,var_entry:StringVar=None,entry_width:int=20):
        ...
        self.__entry = ttk.Entry(master=self,textvariable=self.var_entry,width=entry_width)
